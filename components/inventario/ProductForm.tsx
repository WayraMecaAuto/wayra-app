...
export function ProductForm({ 
  ...
  useEffect(() => {
    if (product && isOpen) {
      ...
      // Solo generar código de barras si no es tornillería
      if (tipo !== 'TORNILLERIA') {
      ...
      // Configurar IVA por defecto según el tipo
  ...
  return (
    <>
      <Modal 
        ...
        size="xl"
      >
        <div className="h-full sm:max-h-[85vh] overflow-y-auto">
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6 p-1">
            
            {/* Header optimizado para móvil */}
            <div className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-3 sm:p-6 rounded-xl sm:rounded-2xl border border-blue-100 shadow-sm">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
                        <div className="flex flex-wrap gap-2 text-xs sm:text-sm text-gray-600">
                          <span className="px-2 py-1 sm:px-3 bg-white rounded-full font-medium whitespace-nowrap">
                            Margen: {config.margenGanancia}%
                          </span>
                          <span className="px-2 py-1 sm:px-3 bg-white rounded-full font-medium">
            ...
            <div className="space-y-4 sm:space-y-0 sm:grid sm:grid-cols-1 lg:grid-cols-2 sm:gap-6 lg:gap-8">
              ...
              <div className="space-y-4 sm:space-y-6">
                    ...
                    <Input
                      ...
                      className={`h-10 sm:h-12 text-sm sm:text-base font-mono font-semibold transition-all duration-300 ${
                        errors.codigo 
                          ...
                          : 'border-gray-300 focus:border-purple-500 focus:ring-purple-500 hover:border-gray-400'
                ...
                {/* Código de Barras - Solo si no es tornillería */}
                {tipo !== 'TORNILLERIA' && (
                  <div className="space-y-2 sm:space-y-3">
                    <label className="block text-sm font-semibold text-gray-700">
                      Código de Barras
                    ...
                    <div className="flex space-x-2 sm:space-x-3">
                      <div className="flex-1 relative group">
                        <Input
                          ...
                          className="h-10 sm:h-12 text-sm sm:text-base font-mono border-gray-300 focus:border-blue-500 focus:ring-blue-500 hover:border-gray-400 transition-all duration-300"
                        />
                      </div>
                      <Button
                        type="button"
                        ...
                        className="px-2 sm:px-4 h-10 sm:h-12 transition-all duration-300 hover:bg-blue-50 hover:border-blue-300"
                      >
                      ...
                      {watch('codigoBarras') && (
                        <Button
                          ...
                          className="px-2 sm:px-4 h-10 sm:h-12 transition-all duration-300 hover:bg-emerald-50 hover:border-emerald-300"
                        >
                ...
                <div className="space-y-2 sm:space-y-3">
                  ...
                  <div className="relative group">
                    <textarea
                      ...
                      className="w-full px-3 py-2 sm:px-4 sm:py-3 text-sm sm:text-base border border-gray-300 rounded-lg sm:rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent resize-none transition-all duration-300 hover:border-gray-400"
                    />
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4 sm:space-y-6">
                <div className="flex items-center space-x-3 mb-4 sm:mb-6">
                  <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-emerald-500 to-green-600 rounded-lg sm:rounded-xl flex items-center justify-center">
                  ...
                  <div className="space-y-2 sm:space-y-3">
                    ...
                    <div className="relative group">
                      <select
                        ...
                        className="w-full h-10 sm:h-12 px-3 sm:px-4 text-sm sm:text-base font-semibold border border-gray-300 rounded-lg sm:rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all duration-300 hover:border-gray-400"
                ...
                {/* Sección avanzada colapsable en móvil */}
                ...
                <div className={`space-y-4 ${!showAdvanced ? 'hidden sm:block' : ''}`}>
                  {/* Stock */}
                  <div className="grid grid-cols-2 gap-3 sm:gap-4">
                    <div className="space-y-2 sm:space-y-3">
                      ...
                      <Input
                        ...
                        placeholder="5"
                        defaultValue="5"
                        className="h-10 sm:h-12 text-sm sm:text-base font-semibold border-gray-300 focus:border-blue-500 focus:ring-blue-500 hover:border-gray-400 transition-all duration-300"
                      />
                    </div>
                  ...
                  {!config.ivaObligatorio && (
                    <div className="p-3 sm:p-4 bg-gradient-to-r from-amber-50 to-yellow-50 border border-amber-200 rounded-lg sm:rounded-xl">
            ...
            {/* Vista previa de precios responsiva */}
            {previewPrices && (
              <div className="relative overflow-hidden bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-emerald-200 shadow-lg">
                ...
                <div className="relative z-10">
                  ...
                  {/* Grid responsivo para precios */}
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6">
                    <div className="text-center p-4 sm:p-5 bg-white/80 backdrop-blur-sm rounded-lg sm:rounded-xl shadow-sm border border-white/50">
                      <div className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 sm:mb-3 bg-emerald-500 rounded-lg sm:rounded-xl">
                    ...
                    <div className="text-center p-4 sm:p-5 bg-white/80 backdrop-blur-sm rounded-lg sm:rounded-xl shadow-sm border border-white/50">
                      <div className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 sm:mb-3 bg-blue-500 rounded-lg sm:rounded-xl">
                    ...
                    <div className="text-center p-4 sm:p-5 bg-white/80 backdrop-blur-sm rounded-lg sm:rounded-xl shadow-sm border border-white/50">
                      <div className="flex items-center justify-center w-10 h-10 sm:w-12 sm:h-12 mx-auto mb-2 sm:mb-3 bg-purple-500 rounded-lg sm:rounded-xl">
                  ...
                  <div className="mt-4 sm:mt-6 text-center">
                    <div className="flex flex-wrap justify-center gap-2 sm:gap-4 px-3 sm:px-6 py-2 sm:py-3 bg-white/70 backdrop-blur-sm rounded-full text-xs sm:text-sm font-medium text-gray-700">
            ...
            {/* Código de barras preview responsivo */}
            {tipo !== 'TORNILLERIA' && watch('codigoBarras') && showBarcodePreview && (
              <div className="bg-gradient-to-br from-gray-50 to-slate-100 p-4 sm:p-6 rounded-xl sm:rounded-2xl border border-gray-200 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row sm:justify-end space-y-3 sm:space-y-0 sm:space-x-4 pt-6 sm:pt-8 border-t border-gray-100 sticky bottom-0 sm:static bg-white sm:bg-transparent p-3 sm:p-0 -mx-1 sm:mx-0">
              <Button
                type="button"
                variant="outline"
                onClick={handleClose}
                disabled={isLoading}
                className="w-full sm:w-auto px-6 sm:px-8 py-3 h-11 sm:h-12 text-sm sm:text-base font-semibold transition-all duration-300 hover:bg-gray-50 order-2 sm:order-1"
              >
                Cancelar
              </Button>
              <Button
                type="submit"
                disabled={isLoading}
                className="w-full sm:w-auto bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 hover:from-blue-700 hover:via-indigo-700 hover:to-purple-700 px-6 sm:px-8 py-3 h-11 sm:h-12 text-sm sm:text-base font-semibold shadow-lg shadow-blue-500/25 transition-all duration-300 order-1 sm:order-2"
              >
                {isLoading && (
