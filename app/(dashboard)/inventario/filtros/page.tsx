...
export default function FiltrosPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div className="bg-gradient-to-r from-teal-500 via-teal-600 to-teal-700 rounded-2xl p-8 text-white shadow-2xl">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h1 className="text-3xl font-bold mb-2">Filtros Automotrices</h1>
              <p className="text-teal-100 text-lg">Filtros de aceite, aire, combustible y más</p>
      ...
      {/* Search and Actions */}
      <Card className="shadow-xl border-0 bg-gradient-to-r from-white to-teal-50">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              ...
              <tbody>
                {filteredProducts.map((product, index) => (
                  <tr 
                    key={product.id} 
                    className={`border-b border-gray-100 hover:bg-gradient-to-r hover:from-teal-25 hover:to-teal-50 transition-all duration-200 ${
            ...
            {filteredProducts.length === 0 && (
              <div className="text-center py-16">
                <div className="w-24 h-24 bg-gradient-to-br from-teal-100 to-teal-200 rounded-2xl flex items-center justify-center mx-auto mb-4">
