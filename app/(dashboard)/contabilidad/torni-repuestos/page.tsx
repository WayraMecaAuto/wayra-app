...
import { TrendingUp, TrendingDown, DollarSign, Wrench, Package, BarChart3, Download } from 'lucide-react'
      ...
      <div className="bg-gradient-to-r from-purple-600 via-purple-700 to-purple-800 rounded-2xl p-6 sm:p-8 text-white shadow-2xl">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-purple-100 text-lg">Reporte de ingresos, egresos y utilidades</p>
          </div>
        </div>
      </div>
